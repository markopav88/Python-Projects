...
print(data)
# should be ['3', '1456', 'S', '25000.00', '6', '2345', 'M', '65000.00', '3', '983', 'H', '55000.00', '4']
def compute_tax_rate(status, taxincome):
    ...
    return rate
compute_tax_rate("H", 20000), compute_tax_rate("H", 30000), compute_tax_rate("H", 40000)



# should print (13, 21, 21)
